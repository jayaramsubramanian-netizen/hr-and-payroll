    ...
    try {
      ...
      // If HR/Management approves, create employee
        ...
        const { error: insertError } = await supabase.from("users").insert({
          ...
          sub_department: request.form_data.subDepartment || null,
          personal_email: request.form_data.personalEmail,
          mobile_number: request.form_data.mobile,
          designation: request.form_data.designation,
          employment_status: "Active",
          date_of_joining: request.form_data.dateOfJoining,
          date_of_birth: request.form_data.dob,
          current_address: request.form_data.address,
          sex: request.form_data.sex,
          nationality: request.form_data.nationality,
          religion: request.form_data.religion,
          phone_number: request.form_data.phone,
          marital_status: request.form_data.maritalStatus,
          educational_qualification: request.form_data.educationalQualification,
          pan_number: request.form_data.panNumber,
          aadhaar_number: request.form_data.aadhaarNumber,
          pf_number: request.form_data.pfNumber,
          esi_number: request.form_data.esiNumber,
          blood_group: request.form_data.bloodGroup,
          bank_name: request.form_data.bankName,
          account_name: request.form_data.accountName,
          account_number: request.form_data.accountNumber,
